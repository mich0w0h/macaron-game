...
public class CriAtomEx3dRegion : CriDisposable
{
	...
	/**
	 * <summary>3Dリージョンを破棄可能かどうかのチェック</summary>
	 * <returns>3Dリージョンの状態（true = 破棄可能、false = 破棄不可）</returns>
	 * <remarks>
	 * <para header='説明'>3Dリージョンを破棄可能かどうかをチェックします。<br/>
	 * 3Dリージョンをセットした3D音源、3Dリスナー、3Dトランシーバーがある場合、<br/>
	 * <see cref='Dispose'/> 関数を呼び出しても、破棄に失敗します。<br/>
	 * 破棄する3Dリージョンを設定している全てのオブジェクトを破棄するか、<br/>
	 * 別の3Dリージョンハンドルを設定してください。<br/></para>
	 * </remarks>
	 * <seealso cref='Dispose'/>
	 * <seealso cref='CriAtomEx3dSource.Set3dRegion'/>
	 * <seealso cref='CriAtomEx3dListener.Set3dRegion'/>
	 * <seealso cref='CriAtomEx3dTransceiver.Set3dRegion'/>
	 */
	...
	private static class UnsafeNativeMethods
	{
		...
		internal static bool criAtomEx3dRegion_IsDestroyable(IntPtr ex3dRegion) { return true; }
#endif
	}
} // end of class
